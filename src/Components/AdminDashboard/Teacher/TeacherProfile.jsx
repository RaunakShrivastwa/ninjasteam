...
const TeacherProfile = () => {
    ...
    return (
        <div class="mt-4 mx-5 p-3 border border-3 border-dark">
                    ...
                    <div class="card h-100 px-3">
                        <div class="card h-100 py-0 my-2 border border-2 border-dark px-3">
                            <div class="d-flex justify-content-start align-items-center">
                                <img src="https://cdn3.iconfinder.com/data/icons/web-design-and-development-2-6/512/87-1024.png" class="img-fluid" alt="profile_img" style={{ width: '95px' }} />

                                <div class="card-body m-0">
                                    <h3 class="card-title fw-bold mb-0 p-0">Abhijeet Kumar</h3>
                                    <p class="fs-6 mt-0 p-0">
