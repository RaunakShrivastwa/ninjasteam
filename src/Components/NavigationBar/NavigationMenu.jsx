        ...
        <div className="container-fluid">
          <Link className="navbar-brand" to="#">
            <img
              className="logos"
              width="30px"
              src="https://cdn-icons-png.flaticon.com/128/1828/1828231.png"
              alt=""
              srcset=""
            />
          </Link>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="item nav-item">
                <Link
                  className="nav-link"
                  to="/ourNinja/AllJobs"
                  onClick={(e) => handleItemClick(e, "All Jobs")}
                  style={getActiveStyles("All Jobs")}
                >
                  All Jobs
                </Link>
              </li>
              <li className="nav-item">
                <Link
                  className="nav-link"
                  to="/can/course"
                  onClick={(e) => handleItemClick(e, "Courses")}
                  style={getActiveStyles("Courses")}
                >
                  Courses
                </Link>
              </li>
              ...
              <li className="item nav-item">
                <Link
                  ...
                  style={getActiveStyles("About Us")}
                >
                  About Us
                </Link>
              </li>
              ...
              <li className="item nav-item">
                <Link
                  className="nav-link"
                  to="#"
                  onClick={(e) => handleItemClick(e, "Blogs")}
                  style={getActiveStyles("Blogs")}
                >
                  Blogs
                </Link>
              </li>
            ...
            <form className="d-flex">
              ...
              <img
                ...
                src="https://res.cloudinary.com/dzhl7dmsp/image/upload/v1709408497/rqvcmfmiujmk8xs3iwkt.jpg"
                alt=""
                srcset=""
              />
            </form>
