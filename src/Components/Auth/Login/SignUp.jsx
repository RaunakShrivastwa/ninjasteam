...
function SignUp() {
    ...
    return (
        <div className='vw-100 vh-100 p-3 d-flex justify-content-center align-items-center'>
            <MDBContainer>
                <MDBRow className='h-100 shadow'>
                    <MDBCol className="col-md-6 col-sm-12 m-auto">
                        <div className="">
                    ...
                    <MDBCol className="col-sm-12 col-md-6 d-none d-lg-block d-xl-block d-md-block">
