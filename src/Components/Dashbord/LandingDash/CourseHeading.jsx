                        ...
                        <div class="card" style={{ maxHeight: '540px', border: '0' }}>
                            <div class="row g-0">
                                <div className="col-md-2 d-flex justify-content-around align-items-center" style={{ background: '#2d3668', border: '0' }}>
                                    <img style={{ borderRadius: '50%', cursor: 'pointer', width: '130px', height: '120px' }} title={user?.userName} src={user?.profile} class=" img-fluid" alt="..." />
                                </div>
                                <div class="col-md-10">
                                    <div class="card-body" style={{ background: '#2d3668' }}>
                                        ...
                                        <button className='btn room'>Download Browchers</button>
                                    </div>
                                </div>
                            </div>
                        </div>
